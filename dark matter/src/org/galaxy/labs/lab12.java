...
public class lab12 {
	...
	public static void main(String[] args) {
		...
		File cipher = new File("/Users/sdu@XactlyCorporation.local/blackhole/dark matter/src/org/galaxy/labs/Cipher.txt"), replace = new File("/Users/sdu@XactlyCorporation.local/blackhole/dark matter/src/org/galaxy/labs/Replace.txt");
		...
		while (stillInUse == 1) {
			...
			if (stillInUse == 0) { // outputting text to file
				File output = new File("/Users/sdu@XactlyCorporation.local/blackhole/dark matter/src/org/galaxy/labs/output.txt");
				Scanner file3 = null;
