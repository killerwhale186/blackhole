...
public class MirrorGameV2 {
	...
	public static void main(String[] args) {
		...
		int choice, correctguesses = 0, incorrectguesses = 0;
		...
		System.out.println("You made " + correctguesses + " correct guesses and " + incorrectguesses + " incorrect guesses.");
	}
	...
	public static char[][] makeBoard(int totalMirrors) {
		...
		mirrortype[1] = FORWARD_MIRROR_HIDDEN;
